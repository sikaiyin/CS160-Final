...
public class LearningScreenActivity3Health2Examination extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learningscreen3health2examination);
    ...
    protected void onStart() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(LearningScreenActivity3Health2Examination.this);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Intent intent = new Intent(LearningScreenActivity3Health2Examination.this, com.example.cs160final.MainActivity.class);
