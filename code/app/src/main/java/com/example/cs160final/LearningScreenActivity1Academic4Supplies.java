...
public class LearningScreenActivity1Academic4Supplies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learningscreen1academic4supplies);
    ...
    protected void onStart() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(LearningScreenActivity1Academic4Supplies.this);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Intent intent = new Intent(LearningScreenActivity1Academic4Supplies.this, com.example.cs160final.MainActivity.class);
