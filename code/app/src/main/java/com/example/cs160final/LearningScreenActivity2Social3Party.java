...
public class LearningScreenActivity2Social3Party extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learningscreen2social3party);
    ...
    protected void onStart() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(LearningScreenActivity2Social3Party.this);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Intent intent = new Intent(LearningScreenActivity2Social3Party.this, com.example.cs160final.MainActivity.class);
