...
public class LearningScreenActivity3Health3Weighing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learningscreen3health3weighing);
    ...
    protected void onStart() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(LearningScreenActivity3Health3Weighing.this);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Intent intent = new Intent(LearningScreenActivity3Health3Weighing.this, com.example.cs160final.MainActivity.class);
