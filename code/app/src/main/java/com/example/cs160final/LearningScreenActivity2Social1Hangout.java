...
public class LearningScreenActivity2Social1Hangout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learningscreen2social1hangout);
    ...
    protected void onStart() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(LearningScreenActivity2Social1Hangout.this);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Intent intent = new Intent(LearningScreenActivity2Social1Hangout.this, com.example.cs160final.MainActivity.class);
